package com.example.BEJ_C2_S3_REST_API_MONGODB_PC_1.domain;
...
public class Customer {
    ...
    public String toString() {
        return "Customer{" + "customerId=" + customerId + ", customerName='" + customerName + '\'' + ", customerPhoneNo=" + customerPhoneNo + ", customerProduct=" + customerProduct + '}';
    }
}
